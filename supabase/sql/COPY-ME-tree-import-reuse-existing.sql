...
-- =============================================================================
-- tree_card import reuse — existing father/ancestors not duplicated
-- Ref: docs/PATCH-TREE-IMPORT-REUSE.md · supabase/sql/20260808_tree_import_reuse_existing.sql
-- Safe to re-run. Replaces admin_tree_children_import_v1 only.
-- =============================================================================
