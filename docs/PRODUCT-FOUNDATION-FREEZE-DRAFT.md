...
**الحالة:** 📝 مسودة جاهزة للتنفيذ — **لا تُعلَن 🟢** ولا تُطبَّق الختم النهائي قبل بوابة 1 🟢  
**أُعدّت:** 2026-08-09  
**الزناد:** بعد إغلاق [`DELEGATES-V2-ACCEPTANCE.md`](./DELEGATES-V2-ACCEPTANCE.md) §6 بالكامل  
**الغرض:** commit واحد يجمّد الدستور الحي + Truth Before Speed ثم يفتح السلّم لـ Request Experience (تصميم أولًا)

> **ممنوع الآن:** تنفيذ هذا التجميد · فتح كود Request Experience · فتح كود Delegate Workspace.
...
- [ ] بوابة 1 🟢 مؤكَّدة من صاحب المنتج
