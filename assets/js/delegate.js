...
function fillWifeFormForEdit(row) {
  ...
  if (wifeFamilyName) wifeFamilyName.value = row.wife_family_name || "";
...
async function saveWifeForSelectedParent() {
  ...
  const row = {
    ...
    wife_branch_key: parseWifeFamilyValue() === false ? null : (wifeBranch && wifeBranch.value ? String(wifeBranch.value).trim() : null),
    wife_family_name: parseWifeFamilyValue() === false && wifeFamilyName && wifeFamilyName.value ? normalizePersonName(wifeFamilyName.value) : null,
